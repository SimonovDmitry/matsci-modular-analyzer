...
from src.preprocessing import ImageLoader, ColorNormalizer, ImageEnhancer, AugmentationPipeline
...
def run_full_demo():
    ...
    loader = ImageLoader()
    original = loader.load(IMAGE_PATH)
    ...
    axes[0].set_title("1. ОРИГИНАЛ", fontsize=12)
    axes[0].axis("off")
    ...
    plt.tight_layout()
    plt.show()
    print("\n На экране сравнение До и После")
